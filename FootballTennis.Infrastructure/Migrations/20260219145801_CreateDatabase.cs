    ...
    public partial class CreateDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamPlayers", x => new { x.TournamentId, x.TeamId, x.PlayerId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamPlayers_Tournaments_TournamentId",
                        column: x => x.TournamentId,
                        principalTable: "Tournaments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_TournamentId_Order",
                table: "Matches",
                columns: new[] { "TournamentId", "Order" });

            migrationBuilder.CreateIndex(
                name: "IX_Matches_TournamentId_TeamOneId_TeamTwoId",
                table: "Matches",
                columns: new[] { "TournamentId", "TeamOneId", "TeamTwoId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sets_MatchId_SetNumber",
                table: "Sets",
